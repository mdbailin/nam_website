...
const accordionData = [
  {
    isExpanded: false,
    title: 'Can you help with Visa Assistance?',
    contents: (
      <div>
        I have helped 100s of expats with their visa needs over the last 10 years.
        I can help you locate a tourist or business visa, as well as a visa for your
        place of employment in Vietnam. I work with trustworthy visa agents that deliver
...
const FAQ = () => {
  return (
    <Box id="FAQ" as="section">
      <Container>
        <BlockTitle
          title="Frequently Ask Questions"
          text="See Some of the Commonly Asked Questions"
        />
        <Flex sx={styles.flex}>
          ...
          <Box sx={styles.content}>
            <Heading as="h3">
              Do you have any quesitons? I am ready to help you.
            </Heading>
            <Text as="p">
              If your question is not list here, please feel free to send me
              an email.
            </Text>
